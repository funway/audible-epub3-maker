...
def test_segment_text_by_re(test_case):
    from audible_epub3_maker.segmenter.text_segmenter import segment_text_by_re
...
def test_replace_non_terminal_dot(test_case):
    from audible_epub3_maker.segmenter.text_segmenter import replace_non_terminal_dot, restore_non_terminal_dot
...
def test_is_readable(text, expected):
    from audible_epub3_maker.segmenter.text_segmenter import is_readable
